...
│   │   ├── noise_agent.py
│   │   ├── value_agent.py
│   │   ├── pov_execution_agent.py
│   │   ├── market_makers/
│   │   │   └── adaptive_market_maker_agent.py
│   │   └── examples/
│   │       └── momentum_agent.py
│   ├── order_book.py          # Central limit order book
│   ├── orders.py              # LimitOrder, MarketOrder, Side
│   ├── price_level.py         # Price-level abstraction
│   ├── messages/              # Order, market-data, and query messages
│   ├── oracles/               # Fundamental-value generators
│   ├── config_system/         # Declarative builder, registry, templates
│   ├── configs/               # Legacy procedural configs (rmsc03, rmsc04)
│   ├── simulation/            # Runner, result, extractors, schemas
│   ├── models/                # Order-size distributions
│   └── utils/                 # Helpers (dollarize, sigmoid, latency)
└── tests/                     # Order book, config, oracle, simulation tests
```
